...
parser.add_argument('--save_model_path', type=str, default='./saved_models/dc_model.p')
parser.add_argument('--load_model_path', type=str, default='./saved_models/dc_model.p')
