...
def convert_source_to_datum(source, N=5, V=512, L=10, compute_sketches=False, top_k_sketches=20, inv_temp=1.0, reward_fn=None, sample_fn=None, dc_model=None):
...
def single_batchloader(data_file, batchsize=100, N=5, V=512, L=10, compute_sketches=False, dc_model=None, shuffle=True, top_k_sketches=20, inv_temp=1.0, reward_fn=None, sample_fn=None):
	...
	if batchsize==1:
		data = (convert_source_to_datum(line, N=N, V=V, L=L, compute_sketches=compute_sketches, dc_model=dc_model, top_k_sketches=20, inv_temp=inv_temp, reward_fn=reward_fn, sample_fn=sample_fn) for line in lines)
...
def batchloader(data_file_list, batchsize=100, N=5, V=512, L=10, compute_sketches=False, dc_model=None, shuffle=True, top_k_sketches=20, inv_temp=1.0, reward_fn=None, sample_fn=None):
	yield from chain(*[single_batchloader(data_file, batchsize=batchsize, N=N, V=V, L=L, compute_sketches=compute_sketches, dc_model=dc_model, shuffle=shuffle, top_k_sketches=top_k_sketches, inv_temp=inv_temp, reward_fn=reward_fn, sample_fn=sample_fn) for data_file in data_file_list])
